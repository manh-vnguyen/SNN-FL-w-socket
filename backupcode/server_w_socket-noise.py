...
def add_noise_to_model(params):
    pass

def write_global_model(file_path, global_model_epoch, global_model_params, global_loss, global_accuracy):
    noise_added_global_model_params = add_noise_to_model(global_model_params)
    global_model_params_payload = msgpack.packb(noise_added_global_model_params, default=msgpack_numpy.encode)
    global_model_size = len(global_model_params_payload)

    with open(file_path, 'wb') as file:
        pickle.dump({
            'global_model_epoch': global_model_epoch,
            'global_model_params': noise_added_global_model_params,
